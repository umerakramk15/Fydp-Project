    ...
    <div className='border-t pt-14'>
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          return (
            <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_auto_auto] sm:grid-cols-[4fr_auto_auto_auto] items-center gap-4'>
              ...
              <input
                ...
                className='border max-w-[60px] sm:max-w-[80px] px-1 sm:px-2 py-1'
                type='number'
                min={1}
