                ...
                <form action="#" className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <input
                                type="email"
                                className="w-full rounded-lg border border-gray-600 p-4 pe-12 text-sm shadow-sm text-black "
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link to={'/forget_password'} className="underline">Forgot Password?</Link>
                    </div>

                    <div>
                        <button
                            type="submit"
                            className="inline-block rounded-lg bg-[#C586A5] px-5 py-3 text-sm font-medium text-white w-full"
                        >
                            Sign in
                        </button>
                    </div>
